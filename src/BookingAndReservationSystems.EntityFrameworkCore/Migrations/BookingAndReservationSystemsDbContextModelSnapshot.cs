...
{
    [DbContext(typeof(BookingAndReservationSystemsDbContext))]
    partial class BookingAndReservationSystemsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReservationSystems.Models.Bookings", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ReservationSystems.Models.Locations", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ReservationSystems.Models.Reviews", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ReservationSystems.Models.Services", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ReservationSystems.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ReservationSystems.Models.Bookings", b =>
                {
                    b.HasOne("ReservationSystems.Models.Services", "Services")
                        .WithMany("Bookings")
                        .HasForeignKey("ServicesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ReservationSystems.Models.User", "Users")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("ReservationSystems.Models.Services", b =>
                {
                    b.HasOne("ReservationSystems.Models.Locations", "Locations")
                        .WithMany("Services")
